...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@MundoPine" },
      { name: "twitter:title", content: "Mundo Pine" },
      { name: "twitter:description", content: "Ferramentas terapêuticas colaborativas para psicólogas infantojuvenis usarem em sessões online com crianças e adolescentes." },
    ],
    links: [
